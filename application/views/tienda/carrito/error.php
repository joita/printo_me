<div class="row ptop">
  <div class="small-24 columns">
    ...
    <p class="text-center" style="margin-bottom:2rem;"><a href="<?php echo site_url('tienda/'.$nombre_tienda_slug.'/carrito/pagar'); ?>" id="descargar_pdf_oxxo" class="button radius">Ir a mi carrito y volver a intentar.</a></p>
  </div>
</div>
