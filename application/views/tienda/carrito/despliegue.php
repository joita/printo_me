<div class="fgc pscat">
	<div class="row small-collapse medium-uncollapse">
		<div class="small-18 columns">
			<?php echo form_open('tienda/'.$nombre_tienda_slug.'/carrito/actualizar'); ?>
							...
							<td class="info-carrito">
								<div class="clearfix">
									...
									<div class="carrito-descripcion">
										...
										<?php /*<a href="<?php echo $this->enhance_modelo->obtener_link_ehnance($options['id_enhance']); ?>" class="more-cantidad" data-tipo="enhance"><i class="fa fa-plus-square"></i> Más<span> tallas</span></a> */ ?>
										<?php
										...
										<?php endif; ?>
										<a href="<?php echo site_url('tienda/'.$nombre_tienda_slug.'/carrito/quitar/'.$items['rowid']); ?>" class="borrar-cantidad"><i class="fa fa-trash"></i><span>Eliminar</span></a>
										<?php else: ?>
										<a class="edit-cantidad-custom" data-open="cantidades_custom" data-id_diseno="<?php echo $options['id_diseno']; ?>" data-tipo="custom"><i class="fa fa-edit"></i> Editar cantidad</a>
										<a href="<?php echo site_url('carrito/borrar_custom_en_carrito/'.$items['rowid'].'/'.$options['id_diseno']); ?>" class="borrar-cantidad-custom"><i class="fa fa-trash"></i><span>Eliminar</span></a>
										<?php endif; ?>
									</div>
								</div>
							</td>
							...
							<td colspan="5">
								<div class="row collapse">
									<div class="small-9 columns">
										<a href="<?php echo site_url('tienda/'.$nombre_tienda_slug); ?>" class="small button" id="agmas"><i class="fa fa-cart-plus"></i><span class="show-for-medium"> Agregar Productos</span></a>
										<a href="<?php echo site_url('tienda/'.$nombre_tienda_slug.'/carrito/vaciar'); ?>" class="small error button" id="vaciar"><i class="fa fa-trash"></i><span class="show-for-medium"> Vaciar</span></a>
									...
									<div class="small-9 text-right columns" id="area_boton_pagar">
										...
										<a href="<?php echo site_url('tienda/'.$nombre_tienda_slug.'/carrito/pagar'); ?>" class="small success button" id="pagmas"><i class="fa fa-check"></i> Pagar</a>
									</div>
								</div>
							</td>
						</tr>
