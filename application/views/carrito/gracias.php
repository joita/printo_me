<div class="row fgc ps ptop">
    ...
    <?php if (!is_null($barcode)) : ?>
		...
		<p class="text-center" style="margin-bottom:2rem;"><a href="<?php echo site_url('carrito/pdf_oxxo/'.$pedido_id); ?>" id="descargar_pdf_oxxo" class="button radius" target="_blank"><i class="fa fa-file-pdf-o"></i> Descargar Ficha de Pago</a></p>
    <?php else: ?>
