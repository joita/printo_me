<h2 class="seccionador show-for-medium text-left" style="color: #025573;font-weight: bold">Plazo Definido</h2>

<div class="row small-collapse medium-uncollapse">
    <input id="tipo" type="hidden" value="limitado">
    <div class="small-18 columns">
        <?php if(sizeof($campanas) > 0): ?>
            <table id="datos" class="campanas-cuenta nowrap" style="width:100%; border: 2px solid #025573; background: none; border-radius: 10px">
                <thead style="width:100%; border: 2px solid #025573; background: none; border-radius: 10px">
                <tr style="width:100%; border: 2px solid #025573; background: none; border-radius: 10px">
                    ...
                    <th style="color: #025573" class="text-center" id="vendidos-campana">Meta</th>
