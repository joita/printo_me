  ...
  <tr>
    <td>
      <div style="padding: 10px 15px;">
        ...
        <p style="font-size:13px;text-align:justify;">Lo sentimos, pero tu pedido No. <?php echo $numero_pedido; ?> ha sido cancelado. El motivo de la cancelación es el siguiente:</p>
        <p style="font-size:13px;text-align:justify;"><?php echo $motivo; ?></p>
		<p style="font-size:13px;text-align:justify;">Te recordamos que los pedidos tienen que cumplir con los <a href="<?php echo site_url('terminos-y-condiciones'); ?>">términos y condiciones</a> de printome.mx.</p>
		<p style="font-size:13px;text-align:justify;">Para cualquier duda o aclaración, comunicate con nosotros contestando este mail.</p>
