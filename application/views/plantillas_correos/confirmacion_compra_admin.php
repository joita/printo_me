<table width="300" style="padding:0;margin:0;border: solid 1px #0a749d;border-radius:3px;width: 100%;max-width: 500px;font-family: Verdana;background-image: url(<?php echo site_url('assets/images/agua.png'); ?>);background-position: -160px;background-repeat: no-repeat;">
  <tr>
	...
	<tr>
		<td>
			<h3 style="text-align: center;margin: 0;line-height: 2;padding-top: 10px;font-weight: normal;">Pago realizado</h3>
			<div style="padding: 10px 15px;">
				<p style="font-size:13px;text-align:justify;">Hola,</p>
				<p style="font-size:13px;text-align:justify;">Se ha confirmado el pago de <?php echo $nombre; ?> para el pedido <strong>No. <?php echo $numero_pedido; ?></strong> por un total de $ <?php echo number_format($total_pedido, 2, ".", ","); ?>. La descripción del pedido viene en el archivo PDF adjunto.</p>
				<p style="font-size:13px;text-align:justify;">E-mail cliente: <?php echo $email; ?></p>
