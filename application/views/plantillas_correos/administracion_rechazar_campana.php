  ...
  <tr>
    <td>
      <div style="padding: 10px 15px;">
        ...
        <p style="font-size:13px;text-align:justify;">Lo sentimos, pero tu campaña "<strong><?php echo $nombre_campana; ?></strong>" ha sido rechazada. El motivo del rechazo es el siguiente:</p>
