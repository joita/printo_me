<table width="300" style="padding:0;margin:0;border: solid 1px #0a749d;border-radius:3px;width: 100%;max-width: 500px;font-family: Verdana;background-image: url(<?php echo site_url('assets/images/agua.png'); ?>);background-position: -160px;background-repeat: no-repeat;">
  <tr>
	...
	<tr>
		<td>
			<h3 style="text-align: center;margin: 0;line-height: 2;padding-top: 10px;font-weight: normal;">Solicitud de factura</h3>
			<div style="padding: 10px 15px;">
				<p style="font-size:13px;text-align:justify;">Hola,</p>
				<p style="font-size:13px;text-align:justify;">Se ha generado una solicitud de factura para el pedido <strong>No. <?php echo $numero_pedido; ?></strong>. Puedes encontrar los datos de facturación en el panel de administración.</p>
