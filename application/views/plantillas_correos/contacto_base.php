	...
	<tr>
		<td>
			<div style="padding: 10px 15px;">
				<p style="font-size:13px;text-align:justify;">Nombre: <?php echo $nombre; ?> 
				<p style="font-size:13px;text-align:justify;">Lugar desde donde contactó: <a href="<?php echo $url; ?>" target="_blank" style="color:#055a7a;text-decoration:underline;font-size:13px;"><?php echo $lugar; ?></a></p>
