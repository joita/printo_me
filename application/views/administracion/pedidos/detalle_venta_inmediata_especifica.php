							...
							<td class="info-carrito">
								<div class="clearfix">
									...
									<div class="carrito-descripcion">
										...
										<?php endif; ?>
										<a class="small button" href="<?php echo site_url('administracion/campanas/fijo/editar/'.($campana->id_parent_enhance == 0 ? $campana->id_enhance : $campana->id_parent_enhance)); ?>#fndtn-resumen_del_pedido" style="margin: 0.7rem 0 0;padding: 0.4rem 1.1rem;">Ir a diseño</a>
									</div>
								</div>
							</td>
