<table cellpadding="0" cellspacing="0" id="carrito" class="tabla-pedidos">
	...
	<?php foreach($pedido->productos as $producto): ?>
		...
		<?php echo ($producto->id_enhance ? ($producto->info_enhance->type == 'limitado' ? '<tr class="coverme"><td colspan="4">Producto de campaña.</td></tr>' : '') : ''); ?>
		<tr<?php echo ($producto->id_enhance ? ($producto->info_enhance->type == 'limitado' ? ' class="enhance"' : '') : ''); ?>>
			...
			<td class="info-carrito">
				<div class="clearfix">
					...
					<div class="carrito-descripcion">
						...
						<span class="carrito-nombre-producto"><?php echo $nombre_producto; ?> <?php if($producto->id_producto == 42):?><span style="color: white; background: red; padding: 0.2rem 0.5rem; border-radius: 1rem; display: inline-block">PRODUCTO DE STOCK</span><?php endif;?></span>
