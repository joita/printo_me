...
var dagFiles = {
	...
	file: {			
		edit: function(path, e){
			...
			if(title != '' && title != null)
			{
				var url = base + 'administracion/media/filefename';				
		...
		remove: function(path, e){
			...
			var url = base + 'administracion/media/fileremove';
	...
	ajax:{
		folder: function(e){	
			...
			var url = base + 'administracion/media/folder';
	...
	folder:{
		...
		add: function(e, path){
			...
			else
			{
				...
				if ( title != null)
				{
					...
					var url = base + 'administracion/media/add';
		...
		rename: function(src, name, e){
			...
			if(typeof e == 'undefined' || e == false)
			{
				...
				if(title != null)
				{
					var url = base + 'administracion/media/rename';
		...
		remove: function(src, o, load){
			...
			else
			{
				...
				var url = base + 'administracion/media/remove';
